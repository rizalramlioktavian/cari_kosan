    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mt-5 mb-5">
              <li class="breadcrumb-item"><a href="{{route('lokasi.index')}}" class="d-flex align-items-center"><iconify-icon icon="iconamoon:arrow-left-2"></iconify-icon>Kembali</a></li>
        ...
        @endif
           ...
           <div class="col-lg-6">
            <div class="deskripsi-kosan">
                ...
                {{-- <p><iconify-icon icon="bx:bx-user" style="color: #e9ed10;"></iconify-icon>5.0({{ $order }}) Orang Telah Memesan </p> --}}
             ...
             {{-- jika sudah jam 23:00 maka tidak bisa pesan kamar lagi (jam 23:00 - 06:00) dan dapat pesan kamar lagi (jam 06:00 - 23:00) --}}
            @if (date('H') >= 23 || date('H') <6)
                <a href="#" class="btn btn-primary w-100 mt-3" disabled>Maaf Anda Tidak Bisa Pesan Kamar, Karena Waktu Pemesana Kamar Hanya Buka Pukul 06:00 -23:00 WIB</a>
            @else
                <a href="{{ route('lokasi.ruang', $kosan->slug) }}" class="btn btn-primary w-100 mt-3" disabled>Pesan Sekarang</a>
            @endif
           </div>
        </div>
