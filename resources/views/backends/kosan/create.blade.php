                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <fieldset class="form-group">
                            <select class="form-select @error('picture') is-invalid @enderror" name="city_id" id="city_id">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('kosan_facility') is-invalid @enderror" name="kosan_facility" id="kosan_facility" placeholder="Enter Kosan_facility"></textarea>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('public_facility') is-invalid @enderror" name="public_facility" id="public_facility" placeholder="Enter Public_facility"></textarea>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('other_facility') is-invalid @enderror" name="other_facility" id="other_facility" placeholder="Enter Other_facility"></textarea>
