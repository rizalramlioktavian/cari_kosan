                                    ...
                                    @foreach ($ruangs as $ruang)
                                        <tr>
                                            ...
                                            {{-- <td>
                                                <ul>
                                                    <li>
                                                    Tersedia: <b><span class="badge bg-{{ $ruang->total_ruang - ($ruang->order ? $ruang->order->where('check_out', '>', now()->format('Y-m-d 14:00:00'))->count() : 0) > 0 ? 'success' : 'danger' }}"> {{ $ruang->total_ruang - ($ruang->order ? $ruang->order->where('check_out', '>', now()->format('Y-m-d 14:00:00'))->count() : 0) }}</span></b> Ruang
                                                    </li>
                                                    <li>
