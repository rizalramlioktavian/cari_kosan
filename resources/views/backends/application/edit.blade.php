...
@section('page-heading', 'Edit Application')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Enter Title">{{ $application->title }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="Enter Description">{{ $application->description }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('img/application/' . $application->picture) }}" alt="{{ $application->title }}" class="rounded-square" width="80" height="100">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="status"
                                    id="status" @if ($application->status == 'show') checked @endif>
